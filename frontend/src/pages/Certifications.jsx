  ...
  return (
    ...
    >
      <div className="border border-neutral-800 bg-neutral-900 hover:border-red-600 transition-colors duration-300 overflow-hidden">
        ...
        <div className="w-full h-48 bg-neutral-800 relative overflow-hidden flex items-center justify-center">
          {cert.thumbnail ? (
            <img
              src={cert.thumbnail}
              alt={cert.title}
            ...
            <>
              ...
              <div className="z-10 text-center">
                <p className="font-mono text-4xl font-bold text-neutral-700 tracking-tighter">
                  {cert.issuer}
                </p>
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="font-mono text-xs text-amber-400 border border-amber-500 border-opacity-50 px-2 py-0.5 tracking-widest">
              {cert.date}
            </span>
          </div>

          {/* Title */}
          <h3 className="font-mono text-xl font-bold text-white tracking-tighter mb-2 group-hover:text-red-500 transition-colors duration-300 leading-snug">
            {cert.title}
          </h3>
          ...
          {cert.credentialUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-mono text-xs tracking-widest uppercase px-5 py-2.5 border border-red-600 text-red-500 hover:bg-red-600 hover:text-white transition-colors duration-300 inline-block"
            >
              Verify Certificate →
            </a>
          )}
